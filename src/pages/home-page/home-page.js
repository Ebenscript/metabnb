        ...
        <div className="home-page__hero">
          <div className="container">
            <div className="d-flex justify-content-space-between align-items-center">
              <div
                className="d-grid home-page__hero-text"
                style={{ "--gap": "48px" }}
              >
                ...
                <form action="#hero-form" className="home-page__hero-form">
                  <input
                    type="text"
                    placeholder="Search for location"
                    className="home-page__hero-form-input"
                  />
                  <Button type="submit" className="home-page__hero-form-button">
                    Search
                  </Button>
                </form>
              </div>
        ...
        <div className="inspiration">
          <div className="container">
            <div className="d-grid" style={{ "--gap": "43px" }}>
              ...
              >
                {places.map((place, i) => {
                  return <PlaceCard image={place} key={i} />;
                })}
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="d-flex justify-content-space-between align-items-center">
              <div className="d-grid text" style={{ "--gap": "57.5px" }}>
                ...
                <div>
                  <Button isLight>Learn more</Button>
                </div>
              </div>

              <div className="d-none lg-d-block images">
                <img src={nftOne} alt="" />
                <img src={nftTwo} alt="" />
